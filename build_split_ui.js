...
const newTabs = `
        ...
        <div class="d-flex mb-4 gap-2 border-bottom pb-3 flex-wrap justify-content-center">
            ...
            <a href="bot-transaksi.html" class="btn btn-outline-brand" id="tab-bot-trans" style="border-radius: 20px; text-decoration: none;"><i class="fas fa-robot me-2"></i>Transaksi Bot</a>
            <a href="bot-produk.html" class="btn btn-outline-brand" id="tab-bot-prod" style="border-radius: 20px; text-decoration: none;"><i class="fas fa-box-open me-2"></i>Produk Bot</a>
        </div>
`;

// ---------------------------------------------------------
// 1. GENERATE bot-transaksi.html
// ---------------------------------------------------------
const transBody = `
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                <h2 class="fw-bold" style="color: var(--primary);">Transaksi Bot</h2>
    ...
    <script>
        document.getElementById('tab-bot-trans').className = 'btn btn-brand';
...
`;
fs.writeFileSync('public/bot-transaksi.html', topPart.replace('style="display: none;"', '') + newTabs + transBody, 'utf8');

// ---------------------------------------------------------
// 2. GENERATE bot-produk.html
// ---------------------------------------------------------
const prodBody = `
        <div class="d-flex justify-content-between align-items-end mb-4">
            <div>
                <h2 class="fw-bold" style="color: var(--primary);">Produk Bot (Toko 2)</h2>
        ...
        <div id="dashboard-content" class="d-none">
            ...
            <div class="glass-card">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold mb-0"><i class="fas fa-box-open me-2"></i>Kelola Stok & Harga</h5>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    <script>
        document.getElementById('tab-bot-prod').className = 'btn btn-brand';
...
`;
fs.writeFileSync('public/bot-produk.html', topPart.replace('style="display: none;"', '') + newTabs + prodBody, 'utf8');
...
function updateTabs(file, activeId) {
    ...
    // Replace old Navigation Tabs with new ones
    html = html.replace(/<!-- Navigation Tabs -->[\s\S]*?<\/div>/, newTabs.trim());
    // Make the current page tab active (btn-brand instead of btn-outline-brand)
    // Be careful here because it might replace all instances or none if regex isn't careful.
